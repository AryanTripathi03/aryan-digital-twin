...
- Exclude: raw furnace datasets, personnel/customer details, internal reports, credentials, cost figures and unsupported percentage improvements
- Missing confirmation: formal role document, exact approved wording for deployment, dates of operational use and any externally documented outcome

## Travel-operator software

- Role: independent software builder
- Evidence: three public source repositories and Aryan's confirmation that the tools are used by their respective owners
- Verified technical work: charge calculation for several trip types, invoice numbering, PDF composition and Streamlit deployment
- Safe description: billing utilities used by small travel-business owners
- Exclude: customer names, phone numbers, routes, vehicle details and invoice records
